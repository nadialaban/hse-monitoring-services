    ...
    <div>
        ...
        <div v-if="state == 'main'">
            ...
            <div v-if="parts.length == 0 || parts.includes('examinations')">
                ...
                <div class="row">
                    <examination-card :examination="examination" :key="'examination_' + examination.id"
        ...
        <div v-if="state == 'examination_templates'">
            ...
            <div class="row"
                ...
                <div class="col-md-12"><h5>{{ name }}</h5></div>
                <examination-card :examination="examination" :key="'examination_template_' + examination.id"
