...
export default {
    ...
    methods: {
        ...
        save: function (is_template) {
            ...
            if (this.check()) {
                ...
                if (!this.flags.btn_lock) {
                    ...
                    this.axios.post(this.url('/api/settings/examination'), this.examination).then(this.process_save_answer).catch(this.process_save_error);
                }
            }
        },
        process_save_answer: function (response) {
            ...
            if (is_new) Event.fire('examination-created', {
